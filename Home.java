...
public class Home extends JFrame implements ActionListener {
	...
	Home(){
        ...
        JLabel l2 = new JLabel("About EPEC");
        JLabel l3 = new JLabel("EPEC stands for Event Management and Execution Committe. This committe is responsible for hosting all the events that occur in Vishwakarma Institute of Technology(VIT) Pune.");
